...
- [Source Generator](core/source_generator.md) — ShaderParams SRB 代码自动生成
...
- [资产身份追踪](assets/asset_identity.md) — GUID Manifest 系统；其中 material identity 部分含历史演进记录
- [资产管线总览](assets/pipeline_overview.md) — Importer/Meta/Manifest/Workspace 全流程

## RHI (`rhi/`)

- [Diligent 绑定](rhi/diligent_binding.md) — Slot-Based Binding 调研
