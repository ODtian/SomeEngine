...
public static class ClusterLimits
{
    ...
    public const ulong DefaultDeformCacheByteCapacity = 128UL * 1024UL * 1024UL;

    /// <summary>Current engine DeformCache payload stride in bytes.</summary>
    public const uint DefaultDeformCacheStrideBytes = 12;
}
